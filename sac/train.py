...
# Make the environment and normalize the obs
env = gym.make('LunarLanderContinuous-v2', render_mode="rgb_array")

obs_a = 2 / (env.observation_space.high - env.observation_space.low)
obs_b = ((env.observation_space.high + env.observation_space.low) / 
...
optim_a = torch.optim.Adam(actor.parameters(), lr=0.00005)
optim_q1 = torch.optim.Adam(Q1.parameters(), lr=0.0005)
optim_q2 = torch.optim.Adam(Q2.parameters(), lr=0.0005)
